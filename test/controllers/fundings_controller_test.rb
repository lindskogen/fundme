...
class FundingsControllerTest < ActionController::TestCase
  ...
  test "should create funding" do
    assert_difference('Funding.count') do
      post :create, funding: { amount: @funding.amount, project_id: @funding.project_id, user_id: @funding.user_id }
    end
  ...
  test "should update funding" do
    patch :update, id: @funding, funding: { amount: @funding.amount, project_id: @funding.project_id, user_id: @funding.user_id }
    assert_redirected_to funding_path(assigns(:funding))
  end
